...
| `nexa` | Nexa theme — gold accents on a dark grid canvas | `Nexa Agent` | Gold borders and accents (`#FFD83B`) with white body text on dark slate grid background. Diamond/chevron-based spinners. Double carets ASCII art logo. |
| `nexa-light` | Nexa Light theme — dark blue accents on a bright canvas | `Nexa Agent` | Designed for light terminals. Dark blue borders and accents (`#00284b`) with dark slate text. Diamond/chevron-based spinners. Double carets ASCII art logo. |
