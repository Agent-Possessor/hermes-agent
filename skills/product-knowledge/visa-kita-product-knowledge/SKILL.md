...
2. Read `references/knowledge-map.md`, then only the references relevant to the request.
...
5. For acquisition or copy, load the relevant file in `markets/` and `playbooks/marketing-strategy.md`.
6. Before making a claim, check `references/claims-and-compliance.md` and `references/source-register.md`.
